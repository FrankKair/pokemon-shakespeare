from ..services.pokemon import Pokemon, FlavorTextEntry, NameAndURL
from ..services.shakespeare import Translation, Success, Contents
...
pokemon_charizard = Pokemon(name='charizard', flavor_text_entries=[
    FlavorTextEntry(
    ...
    FlavorTextEntry(
        flavor_text='When expelling a\nblast of super\nhot fire, the red\x0cflame at the tip\nof its tail burns\nmore intensely.',
        language=NameAndURL(
            name='en', url='https://pokeapi.co/api/v2/language/9/'),
        version=NameAndURL(
    ...
    FlavorTextEntry(
        flavor_text='It uses its wings\nto fly high. The\ntemperature of its\x0cfire increases as\nit gains exper\xad\nience in battle.',
        language=NameAndURL(
            name='en', url='https://pokeapi.co/api/v2/language/9/'),
        version=NameAndURL(
...
pokemon_charizard_without_description = Pokemon(
    name='no-desc', flavor_text_entries=[])
